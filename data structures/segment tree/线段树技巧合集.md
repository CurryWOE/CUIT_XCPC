...
另一种静态开点，可以使用到的最大下标小于2n，但是常数略差，猜测是访存不够连续，cache经常miss，根据洛谷模板题“线段树3”的测试，大约慢了36%。做法就是当前点的左右儿子是 $mid*2$ 和 $mid*2+1$。mid不能是0，否则根节点和该点冲突

另一种静态开点，也是使用到的最大下标小于2n，常数略好，一个点的编号等于 $l+r | l\ne r$，(中间是按位或)，不过对mid没限制，负数加个偏移即可

第二种静态开点的证明见[帖子](https://www.luogu.com.cn/discuss/531072)第二页，第三种静态开点的[证明](https://www.cnblogs.com/chy-2003/p/11815396.html)
# 动态开点
